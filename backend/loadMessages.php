<?php
   ...
   if (isset($_POST)) {
      if ($func == "Next") {
         $queryLoadMensagens = $connection->prepare("SELECT Key_Mensagem, Nome, Email, Data, Respondido FROM Mensagem ORDER BY Respondido, Data DESC LIMIT ".($indice).",30");
         ...
         $queryLoadMensagens = $connection->prepare("SELECT Key_Mensagem, Nome, Email, Data, Respondido FROM Mensagem ORDER BY Respondido, Data DESC LIMIT ".($indice - 30).",30");
         $queryLoadMensagens->execute();
